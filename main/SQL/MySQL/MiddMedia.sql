...
CREATE TABLE IF NOT EXISTS `middmedia_metadata` (
  `directory` varchar(100) character set utf8 collate utf8_bin NOT NULL,
  `file` varchar(150) character set utf8 collate utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `middmedia_queue` (
  `directory` varchar(100) collate utf8_bin NOT NULL,
  `file` varchar(150) collate utf8_bin NOT NULL,
