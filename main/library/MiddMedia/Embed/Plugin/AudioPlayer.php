	...
	implements MiddMedia_Embed_Plugin 
{
	...
	function getMarkup(MiddMedia_File_MediaInterface $file) {
		...
		return '<textarea rows="6" cols="83"><script type="text/javascript" src="'.$this->audioPlayerUrl.'/audio-player.js"></script><object width="290" height="24" id="'.$fileId.'" data="'.$this->audioPlayerUrl.'/player.swf" type="application/x-shockwave-flash"><param value="'.$this->audioPlayerUrl.'/player.swf" name="movie" /><param value="high" name="quality" /><param value="false" name="menu" /><param value="transparent" name="wmode" /><param value="soundFile='.$httpUrl.'" name="FlashVars" /></object></textarea>';
	}
